...
class CorrectionsView {
  constructor(editor, range, corrections, onConfirm) {
    ...
    // row styling on `ol.list-group` — without all three the list renders as a
    // bare transparent <ol> on top of the buffer text. `intentions` is the
    // reference for this shape.
    this.element.className = "spell-check-corrections select-list popover-list";
