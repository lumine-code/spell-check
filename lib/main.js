...
module.exports = {
  ...
  addKnownWord(event) {
    ...
    if (!target) {
      lumine.notifications.addWarning("No misspelling under the cursor to add.", {
        description:
          "Place the cursor in a word Spell Check reported, with Offer Known Word Actions enabled.",
      });
      return;
    }
